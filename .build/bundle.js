...
module.exports = {"ActionBar":{"Items":[{"OnPress":"/DreamsBank/Actions/CloseModalPage_Cancel.action","Position":"Left","SystemItem":"Cancel"},{"OnPress":"/DreamsBank/Actions/KnowledgePeople/Datos Maestros/Aspirante/Aspirante_CreateEntity.action","Position":"Right","SystemItem":"Save"}]},"Caption":"Create Aspirante Detail","Controls":[{"Sections":[{"_Type":"Section.Type.FormCell","_Name":"SectionFormCell0","Visible":true,"Controls":[{"Caption":"identificacion","_Name":"identificacion","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"nombre","_Name":"nombre","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"edad","KeyboardType":"Number","_Name":"edad","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"ciudad","_Name":"ciudad","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"imagen","_Name":"imagen","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"semestre","KeyboardType":"Number","_Name":"semestre","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"carrera","_Name":"carrera","_Type":"Control.Type.FormCell.SimpleProperty"},{"Mode":"Date","_Name":"fechaNacimiento","Caption":"fechaNacimiento","_Type":"Control.Type.FormCell.DatePicker"},{"Caption":"ciudadNacimiento","_Name":"ciudadNacimiento","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"telefono","_Name":"telefono","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"correo","_Name":"correo","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"direccion","_Name":"direccion","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"contrasena","_Name":"contrasena","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"idProducto_id","AllowMultipleSelection":false,"AllowEmptySelection":true,"IsEditable":true,"IsPickerDismissedOnSelection":true,"IsSelectedSectionEnabled":true,"PickerItems":{"DisplayValue":"{id}","ReturnValue":"{id}","Target":{"EntitySet":"Producto","Service":"/DreamsBank/Services/dreamsbankmov.service"}},"_Name":"idProducto_id","_Type":"Control.Type.FormCell.ListPicker"},{"_Name":"haDonado","Caption":"haDonado","Value":false,"_Type":"Control.Type.FormCell.Switch"},{"Caption":"generico1","_Name":"generico1","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"generico2","_Name":"generico2","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"generico3","_Name":"generico3","_Type":"Control.Type.FormCell.SimpleProperty"}]}],"_Name":"SectionedTable0","_Type":"Control.Type.SectionedTable"}],"_Type":"Page","_Name":"Aspirante_Create","PrefersLargeCaption":true}
...
module.exports = {"Caption":"Aspirante","ActionBar":{"Items":[{"OnPress":"/DreamsBank/Actions/KnowledgePeople/Datos Maestros/Aspirante/NavToAspirante_Create.action","Position":"Right","SystemItem":"Add"}]},"Controls":[{"Sections":[{"Header":{"UseTopPadding":false},"ObjectCell":{"AccessoryType":"disclosureIndicator","Description":"{nombre}","AvatarStack":{"Avatars":[{"Image":""}],"ImageIsCircular":false},"Icons":[],"OnPress":"/DreamsBank/Actions/KnowledgePeople/Datos Maestros/Aspirante/NavToAspirante_Detail.action","StatusImage":"","Title":"{idProducto_id}","Footnote":"{edad}","PreserveIconStackSpacing":false,"StatusText":"{ciudad}","Subhead":"{identificacion}","SubstatusText":"{imagen}"},"EmptySection":{"Caption":"No record found!"},"Search":{"Enabled":true,"Placeholder":"Item Search","BarcodeScanner":true,"Delay":500,"MinimumCharacterThreshold":3},"DataPaging":{"ShowLoadingIndicator":true,"LoadingIndicatorText":"Loading more items, please wait..."},"Target":{"EntitySet":"Aspirante","Service":"/DreamsBank/Services/dreamsbankmov.service","QueryOptions":""},"_Type":"Section.Type.ObjectTable"}],"LoadingIndicator":{"Enabled":true,"Text":"Loading, please wait..."},"_Type":"Control.Type.SectionedTable","_Name":"SectionedTable"}],"_Type":"Page","_Name":"Aspirante_List","PrefersLargeCaption":true}
...
module.exports = {"ActionBar":{"Items":[{"OnPress":"/DreamsBank/Actions/CloseModalPage_Cancel.action","Position":"Left","SystemItem":"Cancel"},{"OnPress":"/DreamsBank/Actions/KnowledgePeople/Datos Maestros/Donante/Donante_CreateEntity.action","Position":"Right","SystemItem":"Save"}]},"Caption":"Create Donante Detail","Controls":[{"Sections":[{"_Type":"Section.Type.FormCell","_Name":"SectionFormCell0","Visible":true,"Controls":[{"Caption":"identificacion","_Name":"identificacion","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"tipo","_Name":"tipo","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"nombre","_Name":"nombre","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"edad","KeyboardType":"Number","_Name":"edad","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"ciudad","_Name":"ciudad","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"empresa","_Name":"empresa","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"telefono","_Name":"telefono","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"correo","_Name":"correo","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"imagen","_Name":"imagen","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"web","_Name":"web","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"direccion","_Name":"direccion","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"contrasena","_Name":"contrasena","_Type":"Control.Type.FormCell.SimpleProperty"},{"Mode":"Date","_Name":"fechaNacimiento","Caption":"fechaNacimiento","_Type":"Control.Type.FormCell.DatePicker"},{"Caption":"idProducto_id","AllowMultipleSelection":false,"AllowEmptySelection":true,"IsEditable":true,"IsPickerDismissedOnSelection":true,"IsSelectedSectionEnabled":true,"PickerItems":{"DisplayValue":"{id}","ReturnValue":"{id}","Target":{"EntitySet":"Producto","Service":"/DreamsBank/Services/dreamsbankmov.service"}},"_Name":"idProducto_id","_Type":"Control.Type.FormCell.ListPicker"},{"_Name":"haDonado","Caption":"haDonado","Value":false,"_Type":"Control.Type.FormCell.Switch"},{"Caption":"generico1","_Name":"generico1","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"generico2","_Name":"generico2","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"generico3","_Name":"generico3","_Type":"Control.Type.FormCell.SimpleProperty"}]}],"_Name":"SectionedTable0","_Type":"Control.Type.SectionedTable"}],"_Type":"Page","_Name":"Donante_Create","PrefersLargeCaption":true}
...
module.exports = {"Caption":"Donante","ActionBar":{"Items":[{"OnPress":"/DreamsBank/Actions/KnowledgePeople/Datos Maestros/Donante/NavToDonante_Create.action","Position":"Right","SystemItem":"Add"}]},"Controls":[{"Sections":[{"Header":{"UseTopPadding":false},"ObjectCell":{"AccessoryType":"disclosureIndicator","Description":"{tipo}","AvatarStack":{"Avatars":[{"Image":""}],"ImageIsCircular":false},"Icons":[],"OnPress":"/DreamsBank/Actions/KnowledgePeople/Datos Maestros/Donante/NavToDonante_Detail.action","StatusImage":"","Title":"{idProducto_id}","Footnote":"{nombre}","PreserveIconStackSpacing":false,"StatusText":"{edad}","Subhead":"{identificacion}","SubstatusText":"{ciudad}"},"EmptySection":{"Caption":"No record found!"},"Search":{"Enabled":true,"Placeholder":"Item Search","BarcodeScanner":true,"Delay":500,"MinimumCharacterThreshold":3},"DataPaging":{"ShowLoadingIndicator":true,"LoadingIndicatorText":"Loading more items, please wait..."},"Target":{"EntitySet":"Donante","Service":"/DreamsBank/Services/dreamsbankmov.service","QueryOptions":""},"_Type":"Section.Type.ObjectTable"}],"LoadingIndicator":{"Enabled":true,"Text":"Loading, please wait..."},"_Type":"Control.Type.SectionedTable","_Name":"SectionedTable"}],"_Type":"Page","_Name":"Donante_List","PrefersLargeCaption":true}
...
module.exports = {"Controls":[{"_Type":"Control.Type.SectionedTable","_Name":"SectionedTable0","Sections":[{"_Type":"Section.Type.ButtonTable","_Name":"SectionButtonTable0","EmptySection":{"FooterVisible":false},"Buttons":[{"_Name":"SectionButton0","Title":"Aspirante","Alignment":"Center","ButtonType":"Text","Semantic":"Tint","OnPress":"/DreamsBank/Actions/KnowledgePeople/Datos Maestros/Aspirante/NavToAspirante_List.action"},{"_Name":"SectionButton1","Title":"Donante","Alignment":"Center","ButtonType":"Text","Semantic":"Tint","OnPress":"/DreamsBank/Actions/KnowledgePeople/Datos Maestros/Donante/NavToDonante_List.action"},{"_Name":"SectionButton2","Title":"Producto","Alignment":"Center","ButtonType":"Text","Semantic":"Tint","OnPress":"/DreamsBank/Actions/KnowledgePeople/Datos Maestros/Producto/NavToProducto_List.action"}]}]}],"_Type":"Page","_Name":"Main","Caption":"Main","PrefersLargeCaption":true}
...
module.exports = {"Caption":"Producto","ActionBar":{"Items":[{"OnPress":"/DreamsBank/Actions/KnowledgePeople/Datos Maestros/Producto/NavToProducto_Create.action","Position":"Right","SystemItem":"Add"}]},"Controls":[{"Sections":[{"Header":{"UseTopPadding":false},"ObjectCell":{"AccessoryType":"disclosureIndicator","Description":"{descripcion}","AvatarStack":{"Avatars":[{"Image":""}],"ImageIsCircular":false},"Icons":[],"OnPress":"/DreamsBank/Actions/KnowledgePeople/Datos Maestros/Producto/NavToProducto_Detail.action","StatusImage":"","Title":"{id}","Footnote":"{valor}","PreserveIconStackSpacing":false,"StatusText":"{tipo}","Subhead":"{nombre_producto}","SubstatusText":"{modalidad}"},"EmptySection":{"Caption":"No record found!"},"Search":{"Enabled":true,"Placeholder":"Item Search","BarcodeScanner":true,"Delay":500,"MinimumCharacterThreshold":3},"DataPaging":{"ShowLoadingIndicator":true,"LoadingIndicatorText":"Loading more items, please wait..."},"Target":{"EntitySet":"Producto","Service":"/DreamsBank/Services/dreamsbankmov.service","QueryOptions":""},"_Type":"Section.Type.ObjectTable"}],"LoadingIndicator":{"Enabled":true,"Text":"Loading, please wait..."},"_Type":"Control.Type.SectionedTable","_Name":"SectionedTable"}],"_Type":"Page","_Name":"Producto_List","PrefersLargeCaption":true}
...
module.exports = {"Controls":[{"_Type":"Control.Type.SectionedTable","_Name":"SectionedTable0","Sections":[{"_Type":"Section.Type.ObjectHeader","_Name":"SectionObjectHeader0","ObjectHeader":{"DetailImage":"/DreamsBank/Images/innovar.png","DetailImageIsCircular":false,"HeadlineText":"Aportes economicos o de conocimiento a Aspirantes","StatusPosition":"Stacked","StatusImagePosition":"Leading","SubstatusImagePosition":"Leading"},"Visible":true},{"Visible":true,"EmptySection":{"FooterVisible":false},"Separators":{"TopSectionSeparator":false,"BottomSectionSeparator":true,"HeaderSeparator":true,"FooterSeparator":true,"ControlSeparator":true},"_Type":"Section.Type.FormCell","_Name":"SectionFormCell0","Controls":[{"_Type":"Control.Type.FormCell.Button","_Name":"FormCellButton0","IsVisible":true,"Separator":true,"Title":"Datos Maestros","Alignment":"Center","ButtonType":"Text","Semantic":"Tint","Image":"/DreamsBank/Images/innovar.png","ImagePosition":"Leading","OnPress":"/DreamsBank/Actions/KnowledgePeople/Datos Maestros/NavTo_MenuDatosMaestros.action"},{"_Type":"Control.Type.FormCell.Button","_Name":"FormCellButton1","IsVisible":true,"Separator":true,"Title":"Nuevo Proceso","Alignment":"Center","ButtonType":"Text","Semantic":"Tint","Image":"res://mdk_logo.png","ImagePosition":"Leading"},{"_Type":"Control.Type.FormCell.Button","_Name":"FormCellButton2","IsVisible":true,"Separator":true,"Title":"Consultas","Alignment":"Center","ButtonType":"Text","Semantic":"Tint","Image":"res://mdk_logo.png","ImagePosition":"Leading"}]}]}],"_Type":"Page","_Name":"Menu_KnowledgePeople","Caption":"Knowledge People","PrefersLargeCaption":true}
...
module.exports = {"Controls":[{"_Type":"Control.Type.SectionedTable","_Name":"SectionedTable0","Sections":[{"_Type":"Section.Type.ObjectHeader","_Name":"SectionObjectHeader0","ObjectHeader":{"Subhead":"Banco de sueños","Footnote":"0.0.1","DetailImage":"/DreamsBank/Images/dreamsbank.jpg","DetailImageIsCircular":false,"BodyText":"#Application/#AppData/UserId","HeadlineText":"DreamsBank","StatusPosition":"Stacked","StatusImagePosition":"Leading","SubstatusImagePosition":"Leading"},"Visible":true},{"Visible":true,"EmptySection":{"FooterVisible":false},"Separators":{"TopSectionSeparator":false,"BottomSectionSeparator":true,"HeaderSeparator":true,"FooterSeparator":true,"ControlSeparator":true},"_Type":"Section.Type.FormCell","_Name":"SectionFormCell0","Controls":[{"_Type":"Control.Type.FormCell.Button","_Name":"FormCellButton0","IsVisible":true,"Separator":true,"Title":"Knowledge People","Alignment":"Center","ButtonType":"Text","Semantic":"Tint","Image":"res://mdk_logo.png","ImagePosition":"Leading","OnPress":"/DreamsBank/Actions/KnowledgePeople/NavTo_KnowledgePeople.action"}]}]}],"_Type":"Page","_Name":"Main","Caption":"Main","PrefersLargeCaption":true,"ToolBar":{"Items":[{"_Type":"Control.Type.ToolbarItem","_Name":"ToolbarItem1","Caption":"Cerrar sesión","Enabled":true,"Visible":true,"Clickable":true,"Style":"","OnPress":"/DreamsBank/Actions/LogoutMessage.action"},{"_Type":"Control.Type.ToolbarItem","_Name":"ToolbarItem0","Caption":"Actualizar","Enabled":true,"Visible":true,"Clickable":true,"Style":"","OnPress":"/DreamsBank/Actions/AppUpdateProgressBanner.action"}]}}
...
module.exports = {"CreateLinks":[],"OnFailure":"/DreamsBank/Actions/CreateEntityFailureMessage.action","OnSuccess":"/DreamsBank/Actions/CreateEntitySuccessMessage.action","Properties":{"identificacion":"#Control:identificacion/#Value","tipo":"#Control:tipo/#Value","nombre":"#Control:nombre/#Value","edad":"#Control:edad/#Value","ciudad":"#Control:ciudad/#Value","empresa":"#Control:empresa/#Value","telefono":"#Control:telefono/#Value","correo":"#Control:correo/#Value","imagen":"#Control:imagen/#Value","web":"#Control:web/#Value","direccion":"#Control:direccion/#Value","contrasena":"#Control:contrasena/#Value","fechaNacimiento":"#Control:fechaNacimiento/#Value","idProducto_id":"#Control:idProducto_id/#SelectedValue","haDonado":"#Control:haDonado/#Value","generico1":"#Control:generico1/#Value","generico2":"#Control:generico2/#Value","generico3":"#Control:generico3/#Value"},"Target":{"EntitySet":"Donante","Service":"/DreamsBank/Services/dreamsbankmov.service"},"ActionResult":{"_Name":"create"},"_Type":"Action.Type.ODataService.CreateEntity"}
...
module.exports = {"CreateLinks":[],"OnFailure":"/DreamsBank/Actions/CreateEntityFailureMessage.action","OnSuccess":"/DreamsBank/Actions/CreateEntitySuccessMessage.action","Properties":{"id":"#Control:id/#Value","nombre_producto":"#Control:nombre_producto/#Value","descripcion":"#Control:descripcion/#Value","valor":"#Control:valor/#Value","tipo":"#Control:tipo/#Value","modalidad":"#Control:modalidad/#Value","ciudad":"#Control:ciudad/#Value","universidad":"#Control:universidad/#Value","fabricante":"#Control:fabricante/#Value","imagen":"#Control:imagen/#Value","generico1":"#Control:generico1/#Value","generico2":"#Control:generico2/#Value","generico3":"#Control:generico3/#Value"},"Target":{"EntitySet":"Producto","Service":"/DreamsBank/Services/dreamsbankmov.service"},"ActionResult":{"_Name":"create"},"_Type":"Action.Type.ODataService.CreateEntity"}
